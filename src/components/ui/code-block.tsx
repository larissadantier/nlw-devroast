...
function Header({ filename }: { filename?: string }) {
  return (
...
async function Content({ language = "typescript", children, className }: { language?: string; children: ReactNode; className?: string }) {
...
export const CodeBlock = { Root, Content, Header };
